...
nmap <leader>st :call libcallnr("vimtweak64.dll", "SetAlpha", 200)<CR>
nmap <leader>t :call libcallnr("vimtweak64.dll", "SetAlpha", 255)<CR>
autocmd guienter * call libcallnr("vimtweak64.dll","SetAlpha",255)
nmap <leader>qp :call libcallnr("vimtweak64.dll", "EnableMaximize", 1)<CR>
